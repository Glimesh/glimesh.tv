...
var countdownfunction = setInterval(function () {
    ...
    document.querySelector("#timer .days").innerText = days;
    document.querySelector("#timer .hours").innerText = hours;
    document.querySelector("#timer .min").innerText = minutes;
    document.querySelector("#timer .sec").innerText = seconds;

    // If the count down is over, write some text
    if (distance < 0) {
        clearInterval(countdownfunction);
        document.getElementById("timer").innerHTML = "RIP GLIMESH";
    }
}, 1000);