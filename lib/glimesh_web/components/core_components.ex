defmodule GlimeshWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    <label phx-feedback-for={@name} class="flex items-center gap-4 text-sm leading-6 text-white">
      ...
      <input
        ...
        value="true"
        checked={@checked}
        class="rounded border-zinc-300 text-white focus:ring-zinc-900"
        {@rest}
      />
      <%= @label %>
    </label>
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        class={[
          input_border(@errors),
          "w-full bg-gray-700 border-gray-700 text-white rounded shadow-md placeholder-gray-200"
        ]}
        {@rest}
      >
    <%= @value %></textarea>
