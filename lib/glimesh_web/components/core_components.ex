defmodule GlimeshWeb.CoreComponents do
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="fixed inset-0 bg-slate-700/50 transition-opacity"
        aria-hidden="true"
      />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="hidden relative rounded-lg bg-gray-800 p-4 shadow-lg shadow-zinc-700/10 ring-1 ring-zinc-700/10 transition"
            >
