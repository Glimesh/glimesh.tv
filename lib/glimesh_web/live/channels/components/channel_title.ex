defmodule GlimeshWeb.Channels.Components.ChannelTitle do
  ...
  def uneditable_title(assigns) do
    ...
    <div>
      ...
      <div class="space-x-1">
        <.link
          navigate={Routes.streams_index_path(GlimeshWeb.Endpoint, :index, @channel.category.slug)}
        ...
        <%= if @channel.subcategory do %>
          <.link
            navigate={
              Routes.streams_index_path(GlimeshWeb.Endpoint, :index, @channel.category.slug,
