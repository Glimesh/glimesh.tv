    ...
    <div>
      <%= if @subscribed do %>
        ...
        <% else %>
          ...
          <p>
            <%= gettext("Thanks for supporting %{streamer}. Your genuine support is appreciated.",
          ...
          <button class="btn btn-danger btn-block mt-4" phx-click="unsubscribe" phx-throttle="1000">
