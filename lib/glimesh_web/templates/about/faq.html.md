...
The core inspiration of this project has been equality. There are two main problems with existing streaming websites: they take too much of a cut and the gap between streamers is great. Glimesh is our chance to make this right, and build a platform that puts the streamers and community first, not the advertisers.
